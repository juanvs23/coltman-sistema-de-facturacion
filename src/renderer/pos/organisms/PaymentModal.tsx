      ...
      <div className="flex w-full max-w-2xl gap-6 rounded-lg bg-surface-card p-6 shadow-lg">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-3">
            <h3 className="text-title-sm text-ink">Resumen de venta</h3>
            <span className={`rounded px-2 py-0.5 text-caption font-medium ${isFactura ? 'bg-primary/10 text-primary' : 'bg-muted/10 text-muted'}`}>
          ...
          {isFactura && !customerId && (
            <div className="rounded-md bg-warning/10 px-3 py-2 text-caption text-warning mb-3">
              Cliente requerido para emitir factura
            </div>
          )}
