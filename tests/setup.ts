...
window.electronAPI = {
  ...
  getPrinterStatus: async () => ({ success: true, data: { online: false, paperOut: false, drawerOpen: false } }),
  openDrawer: async () => ({ success: true }),
  checkPrinterLicense: async () => ({ success: true, data: { valid: false, message: 'No license' } }),
